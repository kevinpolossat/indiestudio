...
MenuMainPage::setScene() {
    ...
    this->_start->setImage(ResourceManager::device()->getVideoDriver()->getTexture("assets/Start_700x155.png"));
    ...
    this->_settings->setImage(ResourceManager::device()->getVideoDriver()->getTexture("assets/Settings_700x155.png"));
...
//    this->_settings = ResourceManager::device()->getGUIEnvironment()->addStaticText(L"Settings", irr::core::rect<irr::s32>(610, 520.67 + 100, 1310, 675.34 + 100), true, true, 0, -1, true);
    ...
    this->_leave->setImage(ResourceManager::device()->getVideoDriver()->getTexture("assets/Leave_700x155.png"));

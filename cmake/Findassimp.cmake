...
if(WIN32)
    ...
    find_path(
            ...
            PATHS /usr/local/include/ ${BUILD_DEPENDENCIES}/assimp/include/
    )

    find_library(
            assimp_LIBRARIES
            NAMES assimp
            PATHS /usr/local/lib/ ${BUILD_DEPENDENCIES}/assimp/lib
    )
    ...
    if (assimp_FOUND)
        ...
        set(EP_BASE_DIRECTORY ${BUILD_DEPENDENCIES}/assimp_dl)
        ...
        ExternalProject_Add(
                ...
                CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${BUILD_DEPENDENCIES}/assimp
        )

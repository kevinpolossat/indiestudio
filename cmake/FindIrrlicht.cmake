...
ELSE(IRRLICHT_FOUND)
    ...
    set(IRRLICHT_BUILD ${IRRLICHT_DIR}/build)
    set(IRRLICHT_BUILD_INCLUDE ${IRRLICHT_BUILD}/include)
    set(IRRLICHT_BUILD_LIB ${IRRLICHT_BUILD}/lib)
    file(MAKE_DIRECTORY ${IRRLICHT_BUILD})
    file(MAKE_DIRECTORY ${IRRLICHT_BUILD_INCLUDE})
    file(MAKE_DIRECTORY ${IRRLICHT_BUILD_LIB})
